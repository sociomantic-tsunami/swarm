/*******************************************************************************
    ...
    Asynchronously/Selector managed GetSize request class

    Processes the node's output after a GetSize command, and forwards the
...
module swarm.client.request.GetSizeRequest;
...
/*******************************************************************************
    ...
    Template for GetSizeRequest classes
    ...
    ICommandCodes.Value Cmd ) : Base
{
    ...
    ***************************************************************************/
    ...
    override protected void handle__ ( )
    {
        ...
        auto output = this.params.io_item.get_size_info();
        output(this.params.context, this.resources.conn_pool_info.address,
            this.resources.conn_pool_info.port, records, bytes);
    }
}
